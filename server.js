...
const learningDisabilities = {
    'adhd': {
        ...
        'troubleAreas': ['Paying Attention', 'Self-Control', 'Sitting Still', 'Following Directions', 'Managing Emotions', 'Getting or Staying Organized', 'Remembering Information Long Engough to Use it', 'Shifting Focus'],
    ...
    'dyslexia': {
        ...
        'troubleAreas': ['Sounding Out Written Words', 'Recognizing Common Words in Text', 'Spelling', 'Reading Accurately and Smoothly', 'Writing', 'Rhyming', 'Solving Word Problems in Math', 'Learning a Foreign Language'],
    ...
    'dyscalculia': {
        ...
        'troubleAreas': ['Seeing How Numbers Fit Together', 'Counting', 'Calculating', 'Recalling Math Facts Like 2 + 4 = 6', 'Using Concepts Like Less Than', 'Using Symbols Like + and -', 'Telling Left From Right', 'Reading a Clock', 'Working with Dollars and Coins'],
    ...
    'dysgraphia': {
        ...
        'troubleAreas': ['Forming letters', 'Writing grammatically correct sentences', 'Spacing letters correctly', 'Writing in a straight line', 'Holding and controlding a writing tool', 'Writing clearly enough to read back later', 'Writing complete words without skipping letters'],
